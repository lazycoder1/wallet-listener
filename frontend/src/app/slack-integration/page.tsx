...
// Define styles here so they can be shared by SlackIntegrationView and the fallback
...
function SlackIntegrationView() {
  ...
  // This will be shown initially by Suspense, then if status is still null by this component.
  return (
    <div style={containerStyle}>
